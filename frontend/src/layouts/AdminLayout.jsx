  ...
  return (
    <div className="flex min-h-screen">
      ...
      <aside className="w-64 bg-[#0062FF] text-white p-6 flex flex-col gap-4">
        ...
        <Link to="/adminboard" className="flex gap-3 hover:text-gray-400">
          <House /> Dashboard
        </Link>
        <Link to="/adminboard/users" className="flex gap-3 hover:text-gray-400">
          <User /> Utilisateurs
        </Link>
        <Link to="/adminboard/jpo" className="flex gap-3 hover:text-gray-400">
          <DoorOpen /> JPO
        </Link>
